...
//             I am a proficient Full Stack Developer specializing in creating dynamic, responsive, and high-performance web applications. With a solid foundation in Computer Science and Engineering, I expertly utilize modern technologies such as React, Django, Node.js, and Java to craft scalable and robust software solutions. My focus is on aligning technical implementations with business goals to deliver seamless user experiences and drive impactful results.
...
import React from 'react';
import { Code, Palette, Lightbulb, Briefcase, GitBranch } from 'lucide-react';
import myphoto from '../Asset/photo.jpg'; // Import your image here

const About: React.FC = () => {
  const skills = [
    { icon: <Code size={20} />, skill: 'Web Development', tech: 'React, JavaScript' },
    { icon: <GitBranch size={20} />, skill: 'Version Control', tech: 'Git, GitHub' },
    { icon: <Lightbulb size={20} />, skill: 'Backend Development', tech: 'Node.js, Java' },
    { icon: <Palette size={20} />, skill: 'Database Management', tech: 'MongoDB, SQL' },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 animate-slide-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {skills.map(({ icon, skill, tech }, idx) => (
                <div
                  key={idx}
                  className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors cursor-default shadow-sm hover:shadow-md"
                  title={`${skill} (${tech})`}
                >
                  <div className="flex-shrink-0 flex items-center justify-center text-blue-600 dark:text-blue-400">
                    {icon}
                  </div>
                  <span className="text-gray-900 dark:text-gray-100 font-medium leading-tight">
                    {skill}
                    <br />
